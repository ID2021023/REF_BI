...
exports.getClothData = (req, res) => {
    ...
    let sql = "SELECT TO_NUMBER(SUCD) SUCD, BRCD, COMCD, REPLACE(DIMAGEPATH, 'http://211.115.114.220:8080','https://biimage.sisun.com') AS DIMAGEPATH, MAINDIMAGEPATH, STYCD, YSCD, EMPNAME, SOJAENM, SOJAENMOG ,PRDTGU, CUSTNM, TAGPRI, OUTDT, RESEQ, "
